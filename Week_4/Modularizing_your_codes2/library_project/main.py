...
# Add some books
my_data.add_book("Python Basics", "John Doe")
my_data.add_book("Advanced Python", "Jane Smith")
...
# services/library.py - This will udate to save after borrow/return
